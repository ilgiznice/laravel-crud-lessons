        ...
        <div class="container">
            ...
            <div class="content-mid">
                ...
                <div class="mid-popular">
                    ...
                    <div id="app">
                        <div
                                class="col-md-3 item-grid simpleCart_shelfItem"
                                v-for="product in products"
                        >
                            <div class=" mid-pop">
                                <div class="pro-img">
                                    <img v-bind:src="product.image" class="img-responsive" alt="">
                                </div>
                                <div class="mid-1">
                                    <div class="women">
                                        <div class="women-top">
                                    ...
                                    <div class="mid-2">
                                        ...
                                        <form method="POST">
                                            Имя <input type="text" name="name" v-model="product.order.name">
                                            Телефон <input type="text" name="phone" v-model="product.order.phone">
                                            email <input type="text" name="email" v-model="product.order.email">
                                            Адрес <input type="text" name="address" v-model="product.order.address">
                                            <button
                                                    type="button"
                                                    v-on:click="createOrder(product)"
                                            >
                                                <img src="images/ca.png" alt="Заказать">
                                            </button>
                                        </form>
                                        <div class="clearfix"></div>
                                    </div>
