...
new Vue({
  ...
  created: function created() {
    this.$http.get('/admin/product').then(function (response) {
  ...
  methods: {
    createOrder: function createOrder(product) {
      this.$http.post('/admin/order', _extends({}, product.order, {
...
Vue.component('orders', __webpack_require__(9));
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    deleteOrder: function deleteOrder(order) {
      this.$http.delete('/admin/order/' + order.id, { headers: { 'X-CSRF-TOKEN': window.Laravel.csrf } }).then(function (response) {
        console.log(response);
    ...
    confirm: function confirm(order) {
      this.$http.post('/admin/order/' + order.id + '/proceed', {}, { headers: { 'X-CSRF-TOKEN': window.Laravel.csrf } }).then(function (response) {
        console.log(response);
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        ...
        _c("td", [_vm._v("Адрес")]),
        _vm._v(" "),
        _c("td", [_vm._v("Название товара")]),
        _vm._v(" "),
        _c("td", [_vm._v("Статус заказа")]),
        _vm._v(" "),
